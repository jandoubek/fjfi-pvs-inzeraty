<?php
// source: C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/config/config.neon 
// source: C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/config/config.local.neon 

class Container_4575889c74 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app',
			'wwwDir' => 'C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/../temp/cache',
	...
	{
		return new Container_4575889c74_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\e_nastenka\app/../temp/cache/latte');
...
final class Container_4575889c74_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_4575889c74 $container)
	{
