<?php
// source: C:\Users\prcharom\Desktop\EasyPHP-DevServer-14.1VC9\data\localweb\nastenka\app\presenters/templates/Homepage/default.latte

class Templatefcf1f60195a343cd684f377e4ae46b1e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f7b2bb7b9d', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf8daedf402_content')) { function _lbf8daedf402_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb2559e409be_title')) { function _lb2559e409be_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb5a649c83e6_scripts')) { function _lb5a649c83e6_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb23110742e0_head')) { function _lb23110742e0_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
